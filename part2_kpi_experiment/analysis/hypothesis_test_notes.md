...
This represents an improvement of approximately 3.82 percentage points.
...
The result of this test is used to determine whether the new onboarding campaign should be launched to all users. Based on the observed improvement in Paid Conversion Rate, the treatment demonstrates stronger performance than the control experience and supports a launch recommendation, subject to guardrail metric evaluation.
